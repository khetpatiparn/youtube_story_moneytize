...
class CloudflareImageSmokeTests(unittest.TestCase):
    ...
    def test_rejects_input_and_configuration_before_client_access(self):
        cases = [
            ...
            (self._args(output="tmp/a?.jpg"), self._environment()),
            (self._args(output="tmp/a<.jpg"), self._environment()),
            (self._args(output="tmp/CON.jpg"), self._environment()),
            (self._args(output="tmp/name:stream.jpg"), self._environment()),
            (self._args(output="tmp/C:drive-relative.jpg"), self._environment()),
            (self._args(output="tmp/trailing."), self._environment()),
            (self._args(output="tmp/trailing.jpg "), self._environment()),
